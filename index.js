...
const clientSeparatorRouter = require('./routes/clientSeparator.route.js')
...
const budgetSectionRouter = require('./routes/budgetSection.route.js')
...
app.use('/api/client', clientSeparatorRouter)
...
app.use('/api/budget-sections', budgetSectionRouter)
